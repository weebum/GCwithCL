...
parser.add_argument('--img_read_path',type=str,default='/home/weebum/CelebA/img_align_celeba_png')
parser.add_argument('--mask_save_path',type=str,default='/home/weebum/CelebA/img_align_celeba_png_edge')
...
if __name__ == '__main__':
    ...
    for img_name in tqdm(img_flist):
